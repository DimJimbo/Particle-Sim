...
#include </home/jimis/Projects/VSProjects/planet/containers.h>
...
class Simulator {
    public:
        ...
        void update_screen()
        {
            ...
            SDL_RenderPresent(renderer); // draw all stuff on screen (like pygame.display.flip)
        }
